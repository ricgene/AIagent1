  ...
  try {
    ...
    const response = await anthropic.messages.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are an expert home improvement assistant. Your knowledge spans all aspects of home repair, renovation, and maintenance. Keep responses focused on home improvement topics.
